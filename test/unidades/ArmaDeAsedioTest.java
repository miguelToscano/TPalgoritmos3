...
public class ArmaDeAsedioTest {
	...
	@Test
	public void seMueveCorrectamente4() throws NoEsElTurnoDelJugador,PiezaDeshabilitadaEnTurno,casilleroEstaOcupado,MovimientoInvalido, SuperaLimitePoblacional, DistanciaInvalida {
	...
	public void seMueveAUnLugarOcupadoPorEdificioLanzaExcepcion()
			throws NoEsElTurnoDelJugador,PiezaDeshabilitadaEnTurno,MovimientoInvalido,casilleroEstaOcupado, casilleroInvalido, cajaEstaOcupada, SuperaLimitePoblacional, DistanciaInvalida {
		// creo el edificio
		celda = mapa.obtenerCasillero(6, 6);
		Caja caja = mapa.asignarCajaACasillero(celda);
